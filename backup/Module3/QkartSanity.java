...
public class QkartSanity {
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            // Save the username of thenewly registered user
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        // Go to the Login page
    ...
    public static List<String> productlist(WebDriver driver){
        //List<WebElement> ProductListWebElement = driver.findElements(By.className("MuiBox-root css-1gjj37g"));
        List<WebElement> ProductListWebElement = driver.findElements(By.xpath("//div[@class='MuiBox-root css-1gjj37g']/div[1]"));
    
        List<String> StorageProductList = new ArrayList<String>();
    
        for (WebElement product :ProductListWebElement) {
            StorageProductList.add(product.getText());
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus(" TestCase 8",
                    "Test Case Failure. Verify that product added to cart is available when a new tab is opened:","FAIL");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
    ...
    if(productlist(driver).contains(actualproductList)){
        return true;
    }
    ...
    // private static void logStatus(String type, String message, Boolean boolean1) {}

    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        Boolean status = false;
        logStatus("Start Testcase",
                "Test Case 9: Verify that the Privacy Policy,About Us are displayed correctly","DONE");
        ...
        if (!status) {
            logStatus(" TestCase 9",
                    "Test Case Filure. Verify that the Privacy Policy,About Us are displayed correctly:",
                    "FAIL");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        String basePageURL = driver.getCurrentUrl();
         ...
         //2
        driver.findElement(By.linkText("Privacy policy")).click();
        System.out.println(!driver.getCurrentUrl().equals(basePageURL));
       ...
       //3 
        ...
        System.out.println(PrivacyPolicyHeading.getText());

        if(!PrivacyPolicyHeading.getText().trim().equals("Privacy Policy")){
            System.out.println(PrivacyPolicyHeading.getText());
            return false;
        }
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus(" TestCase 10",
                    "Test Case Failure. verify that the “Contact us” link works fine:","FAIL");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
       ...
       // /html/body/div[2]/div[3]/div/section/div/div/div/form/div/div/div[1]/div/h3[2]
        WebElement name = driver.findElement(By.xpath("//input[@placeholder='Name']"));
        name.sendKeys("crio user");

        WebElement email = driver.findElement(By.xpath("//input[@placeholder='Email']"));
        name.sendKeys("criouser@gmail.com");
        ...
        contactNow.click();
        logStatus("End TestCase",
    "Test Case 10: verify that the “Contact Us” link works fine:",status ? "PASS" : "FAIL");
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        logStatus("Start Testcase",
        "Test Case 10: verify that the Advertisements are displayed correctly:",
        "DONE");
        ...
        if (!status) {
            logStatus(" TestCase 11",
                    "Test Case Failure. verify that the Advertisements are displayed correctly:","FAIL");
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
            ...
            status = login.PerformLogin(lastGeneratedUserName, "abc@123");
            if (!status) {
                logStatus("Step Failure", "verify that the Advertisements are displayed correctly", status ? "PASS" : "FAIL");
                    logStatus("End TestCase",
        ...
        Checkout checkoutpage = new Checkout(driver);
        checkoutpage.addNewAddress("Addr line 1 add Line 2 addr line 3");
        checkoutpage.selectAddress("Addr line 1 add Line 2 addr line 3");
        checkoutpage.placeOrder();
        Thread.sleep(3000);
        ...
        status =!driver.getCurrentUrl().equals(currentURL);
        logStatus("Step", "Verify that Advertisement  is clickable", status ? "PASS" : "FAIL");


        logStatus("End TestCase", "Test Case 11: Ensure that the links on the Qkart advertisement are clickable",status ? "PASS" : "FAIL");
